...
const projects: Project[] = [
  ...
  },
  {
    ...
    desc: "약속 잡기의 모든 흐름(장소 검색 → 후보 핀 등록 → 투표 → 확정)을 실시간 채팅 안에서 완결합니다. Next.js 15 App Router + STOMP WebSocket으로 실시간성을 확보하고, Kakao Maps API로 장소 핀 공유를 채팅 메시지와 동일한 인터페이스로 통합했습니다.",
    bullets: [
